...
if(!file.exists('00SourceAll.R')) {
  ...
  source('board.clustering/R/clustering_plot_heatmap.R',encoding='UTF-8')
  source('board.clustering/R/clustering_plot_pca_tsne.R',encoding='UTF-8')
  source('board.clustering/R/clustering_plot_phenotypes.R',encoding='UTF-8')
  source('board.clustering/R/clustering_plot_table_fa_clusters.R',encoding='UTF-8')
  source('board.clustering/R/clustering_plot_table_parallel.R',encoding='UTF-8')
