...
if(!file.exists('00SourceAll.R')) {
  ...
  source('app/R/modules/PlotModule.R',encoding='UTF-8')
  source('app/R/modules/plotModules/dataviewTSNEPlotModule.R',encoding='UTF-8')
  source('app/R/modules/plotModules/examplePlotModule.R',encoding='UTF-8')
  source('app/R/modules/plotModules/PlotModule.R',encoding='UTF-8')
  ...
  source('app/R/server.R',encoding='UTF-8')
  source('app/R/ui.R',encoding='UTF-8')
  ...
  source('base/R/pgx-include.R',encoding='UTF-8')
