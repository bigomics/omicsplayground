...
if(!file.exists('00SourceAll.R')) {
  ...
  source('app/R/server.R.master',encoding='UTF-8')
  source('app/R/ui.R.master',encoding='UTF-8')
  ...
  source('board.user/R/usersettings_server.R',encoding='UTF-8')
  source('board.user/R/usersettings_ui.R',encoding='UTF-8')
