...
if(!file.exists('00SourceAll.R')) {
  ...
  source('utils/ui-bigdashplus.R',encoding='UTF-8')
  source('utils/ui-boardHeader.R',encoding='UTF-8')
  source('utils/ui-code.R',encoding='UTF-8')
  source('utils/ui-colors.R',encoding='UTF-8')
  source('utils/ui-defaults.R',encoding='UTF-8')
  source('utils/ui-DropDownMenu.R',encoding='UTF-8')
  source('utils/ui-links.R',encoding='UTF-8')
  source('utils/ui-modalUI.R',encoding='UTF-8')
  source('utils/ui-plotmodule-old.R',encoding='UTF-8')
  source('utils/ui-PlotModule.R',encoding='UTF-8')
  source('utils/ui-TableModule.R',encoding='UTF-8')
  source('utils/ui-TableModule2.R',encoding='UTF-8')
  source('utils/ui-tooltip.R',encoding='UTF-8')
  source('utils/ui-utils.R',encoding='UTF-8')
  source('utils/ui-vizpanels.R',encoding='UTF-8')
