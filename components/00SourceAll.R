...
if(!file.exists('00SourceAll.R')) {
  ...
  source('board.mofa/R/plot_gsetmofa_factorCor.R',encoding='UTF-8')
  source('board.mofa/R/plot_gsetmofa_traitCor.R',encoding='UTF-8')
  ...
  source('board.mofa/R/table_mofa_enrichment.R',encoding='UTF-8')
  source('board.mofa/R/table_mofa_enrichmentgenes.R',encoding='UTF-8')
  source('board.mofa/R/table_mofa_gene.R',encoding='UTF-8')
  source('board.mofa/R/table_mofa_genetable.R',encoding='UTF-8')
  source('board.mofa/R/table_mofa_gsetmofa_factor.R',encoding='UTF-8')
  source('board.mofa/R/table_mofa_gsetmofa.R',encoding='UTF-8')
