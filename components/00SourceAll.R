...
if(!file.exists('00SourceAll.R')) {
  ...
  source('app_convert/R/convert_server.R',encoding='UTF-8')
  source('app_convert/R/convert_ui.R',encoding='UTF-8')
  source('app_copilot.ivo.SAVE/R/copilot_server.R',encoding='UTF-8')
  source('app_copilot.ivo.SAVE/R/copilot_ui.R',encoding='UTF-8')
  source('app_copilot.ivo.SAVE/R/info_module.R',encoding='UTF-8')
  source('app_copilot.ivo.SAVE/R/utils.R',encoding='UTF-8')
