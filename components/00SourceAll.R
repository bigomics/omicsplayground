...
if(!file.exists('00SourceAll.R')) {
  ...
  source('base/R/modalUI.R',encoding='UTF-8')
  ...
  source('base/R/tooltip.R',encoding='UTF-8')
  ...
  source('board.connectivity/R/connectivity_plot_cmap_FCFCplots.R',encoding='UTF-8')
  source('board.connectivity/R/connectivity_plot_cmapPairsPlot.R',encoding='UTF-8')
