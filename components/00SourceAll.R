...
if(!file.exists('00SourceAll.R')) {
  ...
  source('board.mofa/R/board_mpcsf_server.R',encoding='UTF-8')
  source('board.mofa/R/board_mpcsf_ui.R',encoding='UTF-8')
  ...
  source('board.mofa/R/plot_enrichment.R',encoding='UTF-8')
  ...
  source('board.mofa/R/plot_gsea.R',encoding='UTF-8')
  ...
  source('board.mofa/R/table_gsea.R',encoding='UTF-8')
