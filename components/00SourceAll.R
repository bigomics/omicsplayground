...
if(!file.exists('00SourceAll.R')) {
  ...
  source('base/R/ui-links.R',encoding='UTF-8')
  source('base/R/ui-modalUI.R',encoding='UTF-8')
  source('base/R/ui-plotmodule-old.R',encoding='UTF-8')
  ...
  source('base/R/ui-utils.R',encoding='UTF-8')
  source('base/R/ui-vizpanels.R',encoding='UTF-8')
  ...
  source('board.functional/R/functional_plot_reactome_actmap.R',encoding='UTF-8')
  source('board.functional/R/functional_plot_reactome_graph.R',encoding='UTF-8')
  ...
  source('board.functional/R/functional_table_reactome.R',encoding='UTF-8')
