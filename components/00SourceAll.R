...
if(!file.exists('00SourceAll.R')) {
  ...
  source('app/R/utils/ui-bigdashplus.R',encoding='UTF-8')
  source('app/R/utils/ui-boardHeader.R',encoding='UTF-8')
  source('app/R/utils/ui-code.R',encoding='UTF-8')
  source('app/R/utils/ui-colors.R',encoding='UTF-8')
  source('app/R/utils/ui-defaults.R',encoding='UTF-8')
  source('app/R/utils/ui-DropDownMenu.R',encoding='UTF-8')
  source('app/R/utils/ui-links.R',encoding='UTF-8')
  source('app/R/utils/ui-modalUI.R',encoding='UTF-8')
  source('app/R/utils/ui-plotmodule-old.R',encoding='UTF-8')
  source('app/R/utils/ui-PlotModule.R',encoding='UTF-8')
  source('app/R/utils/ui-TableModule.R',encoding='UTF-8')
  source('app/R/utils/ui-TableModule2.R',encoding='UTF-8')
  source('app/R/utils/ui-tooltip.R',encoding='UTF-8')
