...
- How multiple enriched keywords relate to each other to form coherent biological narratives
- The direction of enrichment (positive vs negative NES) and what it means for each group in the contrast
- Which keywords represent specific vs generic biological processes
- Use quantitative metrics to support your interpretation (cite specific NES values, adjusted p-values, and keyword sizes when available)
