...
2. How upregulated and downregulated genes relate to each other biologically
...
- How the top differentially expressed genes collectively support a coherent biological interpretation
- The biological relevance to the experimental phenotype
- Key driver genes and their known functions
- Use quantitative metrics to support your interpretation (cite specific logFC, q-values when available)
