...
#'
#' @export
expression_plot_FnName_ui <- dataview_plot_averagerank_ui <- function(id,
                                                                      label='',
                                                                      height=c(600, 800)) {
  ns <- shiny::NS(id)
  info_text = ""
...
#' @return
#' @export
expression_plot_FnName_server <- dataview_plot_averagerank_ui <- function(id, watermark = FALSE)
{
