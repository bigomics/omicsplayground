...
#' Drug Connectivity AI Report Controls UI
drugconnectivity_ai_report_controls_ui <- function(id) {
  ns <- shiny::NS(id)
...
#' Drug Connectivity AI Report Controls Server
drugconnectivity_ai_report_controls_server <- function(id, module_choices = NULL) {
