  ...
  tabs <- div(
    ...
    div(
      ...
      shiny::tabsetPanel(
        ...
        shiny::tabPanel(
          ...
          shiny::br(),
          signature_table_overlap_ui(ns("overlapTable")),
          shiny::br(),
          tags$div(
            HTML("
    ...
    div(
      ...
      shiny::tabsetPanel(
        ...
        shiny::tabPanel(
          "Enrichment table",
          signature_table_enrich_by_contrasts_ui(ns("enrichmentContrastTable")),
          shiny::br(),
          signature_table_genes_in_signature_ui(ns("enrichmentGeneTable")),
          shiny::br(),
          tags$div(
            HTML("
