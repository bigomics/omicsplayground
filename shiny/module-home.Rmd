...
USERMODE = factor("basic", levels=c("intruder","basic","pro","developer"))

## if(DEV.VERSION) userlevels = c("basic","pro","developer")
br();
...
observeEvent(input$main_usermode,
{
    if(input$main_usermode == "BASIC") {
        ...
        lapply(c(PRO_SECTIONS), function(sec) {
