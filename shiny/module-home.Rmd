...
showStartupModal.count=0
VERSION='0.99 (always almost)'
showStartupModal <- function(once=FALSE) {    

    if(once && showStartupModal.count>0) return(NULL)
    ...
    showModal(modalDialog(
        fluidRow(
            ...
            column(
                ...
                ##img(src=randomCartoon()$img2,height="350px"),
    ...
    showStartupModal.count <<- showStartupModal.count + 1
...
observeEvent( input$action_play, {
    ...
    ## Sys.sleep(3)
    if(ENABLE_AUTHENTICATION) showLogin()  ## 
    removeModal()    
})
...
showLoadingModal <- function(pgx) {
    showModal(modalDialog(
        ...
        ##HTML("<center><h2>",pgx.randomSlogan(),"</h2></center>"),
...
observeEvent( input$.login, {           
    ...
    ##cat("credentials=",CREDENTIALS[[input$.username]],"\n")    
...
EXPERT_SECTIONS <- list(
    ...
    c('#section-intersection','#section-volcano'),
