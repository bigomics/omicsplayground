...
social_buttons <- function() {
    div(
        ...
        tagList(
            ...
            tipify( tags$a( href="https://omicsplayground.readthedocs.io", icon("youtube"), target="_blank"),
                   "Watch our tutorials on YouTube", placement="top"),
            tipify( tags$a( href="https://github.com/bigomics", icon("github"), target="_blank"),
                   "Get the source code or report a bug at GitHub", placement="top"),
            tipify( tags$a( href="https://docker.com/bigomics", icon("docker"), target="_blank"),
                   "Pull our docker from Docker", placement="top"),
            tipify( tags$a( href="https://groups.google.com/forum/#!forum/omics-playground",
...
cartoon_list <- list(
    ...
    list(slogan="Your analysis doesn't go for coffee breaks", img="gone-for-coffee.png"),
...
showStartupModal <- function(once=FALSE) {    
    ...
    showModal(modalDialog(
        id="modal-splash",
        div( 
            img(src = base64enc::dataURI(file="www/splash/bigomics-splash1.png"), width="auto", height="500px"),
            height="500px", 
...
##particles_json <- jsonlite::fromJSON(file="resources/particles.json")
particles_json <- rjson::fromJSON(file="resources/particles.json")
shinyparticles::particles(particles_json, target_id="modal-splash", element_id="particles")
