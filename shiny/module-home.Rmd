...
observeEvent( input$upload_compute, {
    ...
    if(0) {
        ...
        showModal( modalDialog(
            HTML("Your data will be uploaded for computation. By uploading the data you accept our EULA and you confirm that the data has been anonymized. Research use only."),
            title = NULL,
            size = "s",
            footer = tagList(
                modalButton("Cancel"),
...
observeEvent( c(input$myconfirmation,input$myconfirmation2), {
    ...
    removeModal()
    showModal( modalDialog(
        p("Ready! You can now analyze your uploaded dataset."),
        title = NULL,
        size = "m",
        footer = tagList(
     ...
     ##sendSweetAlert(
     ##    session = session,
     ##    title = "Ready! You can now analyze your uploaded dataset.",
...
observeEvent( input$savedata, {
    ...
    showModal( modalDialog(
        "Sorry. Saving not implemented yet",
