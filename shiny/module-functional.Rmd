...
conditionalPanel(
    ...
    conditionalPanel(
        ...
        tagList(
          tipify(checkboxInput('fa_normalize','normalize activation matrix',TRUE),
                 "Click to fine-tune the coloring of an activation matrices."),
          tipify(checkboxInput('fa_filtertable','filter signficant (tables)',FALSE),
...
GO_network.opts = tagList(
    ...
    tipify( checkboxInput("GO_colorclusters", "Color clusters", TRUE),
...
enrich_wordcloud_opts = tagList(
  enrich_keyword_opts = tagList( selectInput("enrich_wordcloud_exclude","Exclude words:", choices=NULL, multiple=TRUE),
...
enrich_keyword_opts = tagList( tipify( textInput('enrich_keyword_keywords','Keyword:',"cell cycle"),
     "Paste a keyword such as 'apoptosis', 'replication' or 'cell cycle'.", placement="top", options = list(container = "body")))
