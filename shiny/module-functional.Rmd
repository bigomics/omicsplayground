...
actionLink("fa_options", "Options", icon=icon("cog", lib = "glyphicon"))
br();br();
conditionalPanel(
    "input.fa_options % 2 == 1",
    tagList(
        checkboxInput('fa_normalize','normalize activation maps',TRUE)
    )
)
...
if(PRO.VERSION) {
    conditionalPanel(
        ...
        tagList(
            ...
            radioButtons('dsea_label','Label type (CMap)',c("name","moa","target"),inline=TRUE),
