...
FeatureMapInputs <- function(id) {
    ...
    shiny::tagList(
        tags$div(
         HTML("<h3>Cluster Features</h3> Visually explore and compare expression signatures on UMAP plots.
        Feature-level clustering is based on pairwise co-expression between genes (or genesets).
         It allows one to detect gene modules, explore gene neighbourhoods, and identify potential drivers.")
        ),
        shiny::tagList(
