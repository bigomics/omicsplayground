...
br();br();br();br();br();
checkboxInput('gx_top10','top 10',FALSE)
checkboxInput('gx_logscale','log scale',TRUE)
checkboxInput('gx_ungroup','ungroup',FALSE)

br();br();br();
GX.DEFAULTTEST="trend.limma"
GX.DEFAULTTEST=c("trend.limma","edger.qlf","deseq2.wald","edger.lrt")
br();br();br();
if(PRO.VERSION) checkboxGroupInput('gx_testmethod','Test methods:', choices=NULL, inline=TRUE)
