...
selectizeInput("pdx_select","Custom variables:", choices=NULL, multiple=TRUE)
##checkboxInput('pdx_normalize','normalize',TRUE)
br();br();br();
if(DEV.VERSION) checkboxInput('pdx_showloops','detect loops',FALSE)
if(DEV.VERSION) checkboxInput('pdx_posonly','pos.only',FALSE)
if(DEV.VERSION) checkboxInput('pdx_multiomics','multi-omics weighting',FALSE)
