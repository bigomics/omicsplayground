...
selectInput("sig_type",label="Signature type:",choices=c("<custom>","contrast","hallmark","KEGG"))
conditionalPanel(
    "input.sig_type != '<custom>'",
    selectizeInput("sig_feature","Signature:", choices="<custom>", selected="<custom>")
)
textAreaInput("sig_genelistUP", "Genes:", value = IMMCHECK.GENES,
...
sig_getOverlapTable <- reactive({
    ...
    if(0) {
        ...
        dim(G)        
        hc <- hclust(as.dist(cosSparse(t(G))))
