...
```{r}
htmlOutput("curdata8", class="current-data")
##----------------------------------------------------------------------
...
textAreaInput("sig_genelistUP", "Signature:", value = IMMCHECK.GENES,
              rows=6, placeholder="Paste your gene list")
...
sig_overlapScorePlot.RENDER <- reactive({
    ...
    if(ntop < 100 && input$sig_overlapScorePlot_shownames) {
...
sig_overlapScorePlot.opts = tagList(
    radioButtons("sig_overlapScorePlot_ntop","Number of features",c(60,120,250),inline=TRUE),
    checkboxInput("sig_overlapScorePlot_shownames","Show feature names",TRUE)
)
...
fillCol(
    ...
    moduleWidget(sig_table1_module, outputFunc="dataTableOutput"),
    br(),
    moduleWidget(sig_table2_module, outputFunc="dataTableOutput")    
)
