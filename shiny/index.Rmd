...
if(0) {
    load("../pgx/GSE10846-dlbcl-mRNA-8k-LT.pgx")    
    load("../pgx/GSE72056-melanoma-scRNA-vsclusters-s200-8k-LT.pgx")
    load("../pgx/GSE72056-melanoma-scRNA-vspheno-s100-8k-LT.pgx")   
    load("../pgx/rieckmann2017-immprot-8k-LT.pgx")    
    load("../pgx/GSE98638-liver-scRNA-8k-LT.pgx")
    load("../pgx/GSE22886-immune-mRNA-8k.pgx")    
